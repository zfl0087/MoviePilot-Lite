...
- [x] 5.2 经单独批准后将前后端仓库改为 Public。
- [x] 5.3 匿名验证固定提交、LICENSE、构建脚本和发布记录可读。
- [x] 5.4 更新 Docker Hub 描述并链接公开源码和安装文档。

## 6. 创建公开预览 Release

- [x] 6.1 经单独批准后创建不可变前后端标签。
- [x] 6.2 创建 GitHub Pre-release，写明摘要、源码、安装、回退和未验证项。
- [x] 6.3 从匿名环境完成端到端公开访问与拉取验证。
